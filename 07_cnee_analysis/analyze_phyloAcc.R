...
likelihoods$original <- input_lik(file="03_phyloAcc_res/Combined_elem_lik2.txt", "original")
likelihoods$extended <- input_lik(file="03_phyloAcc_res/Combined_elem_lik2-E.txt", "extended")
likelihoods$reduced <- input_lik(file="03_phyloAcc_res/Combined_elem_lik2-R.txt", "reduced")


postmat$original <- input_states(file="03_phyloAcc_res/Combined_max_Z_M2.txt", "original", "maxpost")
postmat$extended <- input_states(file="03_phyloAcc_res/Combined_max_Z_M2-E.txt", "extended", "maxpost")
postmat$reduced <- input_states(file="03_phyloAcc_res/Combined_max_Z_M2-R.txt", "reduced", "maxpost")

posteriors$original <- input_states(file="03_phyloAcc_res/Combined_post_Z_M2.txt", "original", "postprob")
posteriors$extended <- input_states(file="03_phyloAcc_res/Combined_post_Z_M2-E.txt", "extended", "postprob")
posteriors$reduced <- input_states(file="03_phyloAcc_res/Combined_post_Z_M2-R.txt", "reduced", "postprob")
