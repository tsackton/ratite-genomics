...
compute_gene_results <- function(DF, outname) {
...
compute_gene_results(cnee_orig, "original_gene")
compute_gene_results(cnee_ext, "extended_gene")
compute_gene_results(cnee_ext2, "extended_ratiteVcorm_gene")
compute_gene_results(cnee_red, "reduced_gene")
