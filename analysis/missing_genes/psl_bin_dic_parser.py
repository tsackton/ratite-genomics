...
try:
    outlist = []    
    with open('/n/home12/pgrayson/regal/PseudoSearch/genomes/raw/dic2/'+phile.split('.')[0]+".txt",'rU') as outlog:
...
#with open('/n/home12/pgrayson/regal/PseudoSearch/Final/HLO_psl/singles/singles_'+phile.split('.')[0]+str(sys.argv[2])+'.psl', 'rU') as handle: #opens chicken psl (our reference) in universal mode
with open('/n/home12/pgrayson/regal/PseudoSearch/Final/HLO_psl/singles/singles_'+phile.split('.')[0]+'.psl', 'rU') as handle: #opens chicken psl (our reference) in universal mode
...
#with open('/n/home12/pgrayson/regal/PseudoSearch/Final/HLO_psl/singles/singles_'+phile.split('.')[0]+str(sys.argv[2])+'.psl', 'rU') as handle: #opens the target genome
...
try:
    flog = open('/n/home12/pgrayson/regal/PseudoSearch/genomes/raw/dic2/'+phile.split('.')[0]+".txt",'a')
    fout = open('/n/home12/pgrayson/regal/PseudoSearch/Final/HLO_psl/singles/outSingles/concat2_'+phile,'a')
except:
    flog = open('/n/home12/pgrayson/regal/PseudoSearch/genomes/raw/dic2/'+phile.split('.')[0]+".txt",'w')
    fout = open('/n/home12/pgrayson/regal/PseudoSearch/Final/HLO_psl/singles/outSingles/concat2_'+phile,'w') #multifasta out file is created
