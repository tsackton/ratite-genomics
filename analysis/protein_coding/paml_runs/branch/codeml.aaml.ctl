      seqfile = SEQINPUT * sequence data filename
     treefile = TREEINPUT      * tree structure file name
...
*        ndata = 10
   ...
   aaRatefile = /n/home12/tsackton/sw/progs/paml4.9e/dat/wag.dat  * only used for aa seqs with model=empirical(_F)
