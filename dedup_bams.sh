...
java -jar ~/sw/progs/picard-tools-1.121/SortSam.jar INPUT=${SPEC}_frag_mapped.bam OUTPUT=${SPEC}_sorted1.bam SORT_ORDER=coordinate
java -jar ~/sw/progs/picard-tools-1.121/SortSam.jar INPUT=${SPEC}_jump_mapped.bam OUTPUT=${SPEC}_sorted2.bam SORT_ORDER=coordinate
